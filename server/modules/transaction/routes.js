...
exports.init = (router) => {
  router.get(
    '/api/transactions',
    UserMiddleware.withAuth,
    TransactionController.getTransactions
  )
  router.post(
    '/api/transactions',
    compose([UserMiddleware.withAuth, TransactionValidator.createTransaction]),
    TransactionController.createTransaction
  )
  router.put(
    '/api/transactions/:transactionId',
    compose([UserMiddleware.withAuth, TransactionValidator.editTransaction]),
    TransactionController.editTransaction
  )
  router.delete(
    '/api/transactions/:transactionId',
    compose([UserMiddleware.withAuth, TransactionValidator.deleteTransaction]),
  ...
  router.get(
    '/api/portfolio',
    UserMiddleware.withAuth,
    TransactionController.getPortfolio
  )

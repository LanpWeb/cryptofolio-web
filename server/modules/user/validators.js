...
exports.signUp = async (ctx, next) => {
  ...
  if (!passwordSchema.validate(password)) {
    ctx.throw(
      'Password is not valid. It should be without spaces, minimum 8 symbols, with at least one uppercase letter.',
      400
    )
  }
...
exports.changePassword = async (ctx, next) => {
  ...
  if (!passwordSchema.validate(newPassword)) {
    ctx.throw(
      'New password is not valid. It should be without spaces, minimum 8 symbols, with at least one uppercase letter.',
      400
    )
  }

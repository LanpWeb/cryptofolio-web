...
const PortfolioStats = ({
  ...
  return (
    <div className="stats aic jcsb">
      <div className="aic">
        <span className="h3 stats__amount">${amount}</span>
        {amount !== '0' ? (
          <>
            <span className={priceChangeClassName}>
              ...
              {Number(percentChange) > 0 ? (
                <span className="stats__triangle centered">
                  <svg
                    width="8"
                    height="5"
                    fill="none"
                  ...
                  >
                    <path d="M4 0l3.464 4.5H.536L4 0z" fill="#3DB052" />
                  </svg>
                </span>
              ) : (
                <span className="stats__triangle centered">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M4 5L7.464.5H.536L4 5z" fill="#EC6E47" />
                  </svg>
                </span>
              )}
            </span>
          ...
          <span className="stats__text">(Portfolio cost)</span>
        )}
      </div>
      <div className="aic">
        <span className="stats__item aic">
          <span className="c1 fw-medium stats__text stats__text_margin_right">
            24h:
          </span>
          {amount !== '0' ? (
            <>
              <span className={dailyChangeClassName}>{dailyChange}%</span>
            ...
            <span className={dailyChangeClassName}>{amount}%</span>
          )}
        </span>
        <span className="stats__item aic">
          <span className="c1 fw-medium stats__text stats__text_margin_right">
          ...
          {amount !== '0' ? (
            <>
              <span className={weeklyChangeClassName}>{weeklyChange}%</span>
            ...
            <span className={weeklyChangeClassName}>{amount}%</span>
          )}
        </span>
        <span className="stats__item aic">
          <span className="c1 fw-medium stats__text stats__text_margin_right">
          ...
          {amount !== '0' ? (
            <>
              <span className={monthlyChangeClassName}>{monthlyChange}%</span>
            ...
            <span className={monthlyChangeClassName}>{amount}%</span>
          )}
        </span>
      </div>
    </div>

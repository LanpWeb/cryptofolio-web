  ...
  return (
    <div className={dateSelectClassName}>
      <input
        ...
        onClick={() => { if (openCalendar !== "startCalendar") { setOpenCalendar("startCalendar"); } else { setOpenCalendar(""); } }}
      />
      ...
      <input
        ...
        onClick={() => { if (openCalendar !== "endCalendar") { setOpenCalendar("endCalendar"); } else { setOpenCalendar("endCalendar"); } }}
      />
    </div>
  );
};

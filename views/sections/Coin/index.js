...
const Coin = ({ cryptoInfo, auth, watchlist, toggleWatchlist }: Props) => {
  ...
  return (
    <section className="coin">
      ...
      <p>
        Rank #{/* eslint-disable-next-line camelcase */}
      ...
      <p>
        ...
        {cryptoInfo.data &&
          ...
          (
            cryptoInfo.data.quote.USD.volume_24h /
            cryptoInfo.data.quote.USD.price
          ).toLocaleString()}
        {cryptoInfo.data?.symbol}
      </p>
      <br />
      ...
      {cryptoInfo.data && (
        <img
          src={`https://s2.coinmarketcap.com/generated/sparklines/web/7d/usd/${cryptoInfo.data.id}.png`}
          alt="sparkline"
          width="164"
          height="48"
        />
      ...
      <p>Website:</p>
      <ul>
        {cryptoInfo.data?.urls.website.map((url) => (
          <li key={url}>
            <a href={url}>{url}</a>
          </li>
        ))}
      ...
      <p>Explorer:</p>
      <ul>
        {cryptoInfo.data?.urls.explorer.map((url) => (
          <li key={url}>
            <a href={url}>{url}</a>
          </li>
        ))}
      ...
      <ul>
        {/* eslint-disable-next-line camelcase */}
        {cryptoInfo.data?.urls.message_board.map((url) => (
          <li key={url}>
            <a href={url}>{url}</a>
          </li>
        ))}
      ...
      <ul>
        {/* eslint-disable-next-line camelcase */}
        {cryptoInfo.data?.urls.source_code.map((url) => (
          <li key={url}>
            <a href={url}>{url}</a>
          </li>
        ))}
      ...
      <ul>
        {/* eslint-disable-next-line camelcase */}
        {cryptoInfo.data?.urls.technical_doc.map((url) => (
          <li key={url}>
            <a href={url}>{url}</a>
          </li>
        ))}
      ...
      <p>{cryptoInfo.data?.description}</p>
      <br />
      <p>
        {cryptoInfo.data?.name}
        statistics
      ...
      <p>
        {cryptoInfo.data?.name}
        price ${cryptoInfo.data?.quote.USD.price.toLocaleString()}
      </p>
      <p>
        {cryptoInfo.data?.name}
        ROI
      ...
      <p>
        Market rank #{/* eslint-disable-next-line camelcase */}
        {cryptoInfo.data?.cmc_rank}
      </p>
      {/* eslint-disable-next-line camelcase */}
      {cryptoInfo.data?.quote.USD.market_cap && (
        <p>
          Market cap ${/* eslint-disable-next-line camelcase */}
          {cryptoInfo.data?.quote.USD.market_cap.toLocaleString()}
        </p>
      )}
      {/* eslint-disable-next-line camelcase */}
      {cryptoInfo.data?.quote.USD.volume_24h && (
        <p>
          24 volume ${/* eslint-disable-next-line camelcase */}
          {cryptoInfo.data?.quote.USD.volume_24h.toLocaleString()}
        </p>
      )}
      {/* eslint-disable-next-line camelcase */}
      ...
      <p>
        All time high ${/* eslint-disable-next-line camelcase */}
        {cryptoInfo.data?.pricePeriods.all_time.quote.USD.high}
      </p>
      <p>
        All time low ${/* eslint-disable-next-line camelcase */}
